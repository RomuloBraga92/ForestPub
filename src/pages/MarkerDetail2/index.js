...
export default function MarkerDetail2(){
  ...
  useEffect(()=>{
    async function loadPosition(){
      ...
      const userLatitude = latitude.toFixed(5);
      const userLongitude = longitude.toFixed(5);
  ...
  useEffect(()=>{
    ...
    const barLatitude = location[0].latitude;
    const barLongitude = location[0].longitude;
      ...
      <Content>
        <BarImage>
          <ChecksContainer>
            ...
            <ChecksText>67</ChecksText>
          </ChecksContainer>
        </BarImage>
        <BarName>Bar do Arnaldo</BarName>
